...
int main(){
    ...
    do{
        ...
        switch(opcion){
            ...
            break;
            case 5: cout<< "Espanol..."<< endl;
            	if(buscarLibroEsp())
            		cout<<"Si encontramos libros en Espanol"<<endl;
            	else
					
            		cout<<"No encontramos libros en Espanol"<<endl;
           break;
          
		   case 6: cout<<"Hay libros de ciencia ficcion?"<<endl;
            	if(buscarCienciaF())
            	cout<<"Si hay libros de Ciencia Ficcion Yupi"<<endl;
            	else
            	cout<<"No hay libros de Ciencia Ficcion :'("<<endl;
            	break;
            
            case 7: cout<<"Se eliminaron los libros"<<endl;
            eliminarLM();
            break;
